...
- **Image zoom** — any image on the front or back of a card has a small expand button (⛶) in its corner; tap or click it to open a full-screen lightbox; **pinch to zoom** in and out on the image; tap the background, press ✕, or press **Escape** to close
...
- **Image zoom** — any image in a question or answer choice has a small expand button (⛶) in its corner; tap or click it to open a full-screen lightbox without selecting that answer choice; **pinch to zoom** in and out on the image; tap the background, press ✕, or press **Escape** to close
